...
def get_args():
    ...
    parser.add_argument("--input_dir", type=str, default='/home/phosphenesvision/FaceDetection/UFDD/UFDD_val/images/rain/')
    parser.add_argument("--output_dir", type=str, default='/home/phosphenesvision/FaceDetection/UFDD/UFDD_val/changed/rain/')

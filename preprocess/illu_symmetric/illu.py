...
@LastEditTime: 2020-07-13 21:02:39
'''
import os
import cv2
import math
...
def zmIce(I, ratio=4, radius=300):                     #常规的ACE实现  
    ...
    zh,zw = [0]*radius + [i for i in range(height)] + [height-1]*radius, [0]*radius + [j for j in range(width)]  + [width -1]*radius  
    Z = I[np.ix_(zh, zw)]  
